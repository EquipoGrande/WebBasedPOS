...
class CurrentInventory {
    constructor(){
        ...
        this.productList = [new Product(0, "Apple",3.00,1.00,20.0,"Kg"), new Product(1, "Orange",3.00,1.00,20.0,"Kg"), new Product(2, "Banana",3.00,1.00,20.0,"Kg"), 
            new Product(3, "Pear",3.00,1.00,20.0,"Kg"), new Product(4, "Grape Fruit",3.00,1.00,20.0,"Kg"), new Product(5, "Fuji Apple",3.00,1.00,20.0,"Kg"),
            new Product(6, "Honey Crisp Apple",3.00,1.00,20.0,"Kg"), new Product(7,"Yams",3.00,1.00,20.0,"Kg"), new Product(8, "White Grapes",3.00,1.00,20.0,"Kg"),
            new Product(9, "Raspberry",3.00,1.00,20.0,"Kg"), new Product(10, "Black Berry",3.00,1.00,20.0,"Kg"), new Product(11, "Cherry",3.00,1.00,20.0,"Kg"),
            new Product(12, "Strawberry",3.00,1.00,20.0,"Kg"), new Product(13, "Potato",3.00,1.00,20.0,"Kg"), new Product(14, "Carrot",3.00,1.00,20.0,"Kg"),
